		...
		<table border="1">
			<tr>
				<td colspan="5" align="right">
					<button onclick="location.href='${cp}/member/joinForm'">가입하기</button>
					<c:if test="${sessionScope.log eq null }">
						<button onclick="location.href='${cp}/member/loginForm'">로그인</button>
					</c:if>
					<c:if test="${sessionScope.log ne null}">
						<button onclick="location.href='${cp}/member/logout'">로그아웃</button>
					</c:if>
				</td>
			</tr>
			<tr height="40">
